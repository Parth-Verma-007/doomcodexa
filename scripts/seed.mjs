...
const PEOPLE = [
  { username: 'parth', email: 'parth@codexa.app', password: 'admin123' },
  { username: 'joel', email: 'joel@codexa.app', password: 'admin321' },
  { username: 'raghav', email: 'raghav@codexa.app', password: 'admin147' },
];
